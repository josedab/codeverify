...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "triggered_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "dismissed_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True
        ),
