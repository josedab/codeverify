    ...
    def add_endpoint(self, endpoint: Endpoint):
        ...
        if endpoint.request_body:
            operation["requestBody"] = {
                ...
                "content": {
                    endpoint.request_body.content_type: {"schema": endpoint.request_body.schema}
                },
            }
...
""",
    ...
    api.add_schema(
        "FingerprintResult",
        {
            ...
            "properties": {
                ...
                "origin": {
                    "type": "string",
                    "enum": ["human", "ai_generated", "ai_assisted", "unknown"],
                },
                "confidence_score": {"type": "number", "minimum": 0, "maximum": 1},
                "detected_tools": {"type": "array", "items": {"type": "string"}},
                "signals": {
                    "type": "array",
                    "items": {
                        "type": "object",
    ...
    api.add_schema(
        "ReachabilityResult",
        {
            ...
            "properties": {
                ...
                "status": {
                    "type": "string",
                    "enum": ["reachable", "unreachable", "unknown", "timeout"],
                },
    ...
    api.add_schema(
        "SBOMRequest",
        {
            ...
            "properties": {
                ...
                "format": {
                    "type": "string",
                    "enum": ["cyclonedx_json", "cyclonedx_xml", "spdx_json"],
                },
        ...
        Endpoint(
            ...
            responses=[
                Response(
                    ...
                    schema={"$ref": "#/components/schemas/ReachabilityResult"},
                ),
                Response(400, "Invalid request", schema={"$ref": "#/components/schemas/Error"}),
            ],
        )
    ...
    api.add_endpoint(
        Endpoint(
            ...
            responses=[
                ...
                Response(400, "Invalid request", schema={"$ref": "#/components/schemas/Error"}),
                Response(
                    422, "Unable to generate fix", schema={"$ref": "#/components/schemas/Error"}
                ),
            ],
        )
    )
    ...
    api.add_endpoint(
        Endpoint(
            ...
            tags=["autofix"],
            parameters=[Parameter("id", "path", "Fix ID", required=True)],
            request_body=RequestBody(
            ...
            responses=[
                Response(
                    201,
                    "PR created",
                    schema={"type": "object", "properties": {"pr_url": {"type": "string"}}},
                ),
        ...
        Endpoint(
            ...
            responses=[
                Response(
                    201,
                    "Spec registered",
                    schema={"type": "object", "properties": {"spec_id": {"type": "string"}}},
                ),
    ...
    api.add_endpoint(
        Endpoint(
            ...
            responses=[
                Response(
                    200, "Generated probe code", schema={"$ref": "#/components/schemas/ProbeCode"}
                )
            ],
        )
    )
    ...
    api.add_endpoint(
        Endpoint(
            ...
            parameters=[
                ...
                Parameter(
                    "per_page", "query", "Items per page", schema={"type": "integer", "default": 20}
                ),
            ],
            responses=[
                Response(
    ...
    api.add_endpoint(
        Endpoint(
            ...
            parameters=[
                ...
                Parameter(
                    "end_date", "query", "Period end", schema={"type": "string", "format": "date"}
                ),
    ...
    api.add_endpoint(
        Endpoint(
            ...
            responses=[Response(200, "Detected patterns", schema={"type": "object"})],
        )
    )
    ...
    api.add_endpoint(
        Endpoint(
            ...
            tags=["intelligence"],
            parameters=[Parameter("repository", "query", "Repository", required=True)],
            responses=[Response(200, "Dependency graph", schema={"type": "object"})],
        )
    )
                    ...
                    "properties": {
                        "ticket": {
                            ...
                            "properties": {
                                ...
                                "provider": {
                                    "type": "string",
                                    "enum": ["jira", "linear", "github", "gitlab"],
                                },
                            },
                        },
                        "diff": {"type": "string"},
        ...
        Endpoint(
            ...
            responses=[
                Response(
                    201,
                    "Session created",
                    schema={"$ref": "#/components/schemas/PlaygroundSession"},
                )
            ],
        )
    )
    ...
    api.add_endpoint(
        Endpoint(
            ...
            tags=["playground"],
            parameters=[Parameter("session_id", "path", "Session ID", required=True)],
            responses=[
                Response(
                    200,
                    "Session details",
        ...
        Endpoint(
            ...
            request_body=RequestBody(
                ...
                schema={
                    ...
                    "properties": {
                        "action": {
                            "type": "string",
                            "enum": ["forward", "backward", "reset", "goto"],
                        },
                        "step": {"type": "integer"},
                    },
                    "required": ["action"],
            ...
            responses=[
                Response(
                    200,
                    "Navigation result",
                    schema={"type": "object", "properties": {"current_step": {"type": "integer"}}},
                )
            ],
        )
    )
        ...
        Endpoint(
            ...
            parameters=[
                ...
                Parameter(
                    ...
                    "Export format",
                    required=True,
                    schema={"type": "string", "enum": ["html", "mermaid"]},
                ),
            ],
            responses=[
                Response(
        ...
        Endpoint(
            ...
            parameters=[
                Parameter(
                    ...
                    schema={
                        "type": "string",
                        "enum": ["github", "gitlab", "bitbucket", "gitea", "gerrit", "azure"],
                    },
                )
            ],
            responses=[
                Response(
                    200, "Webhook processed", schema={"$ref": "#/components/schemas/WebhookPayload"}
                ),
    ...
    api.add_endpoint(
        Endpoint(
            ...
            responses=[Response(200, "Verification result", schema={"type": "object"})],
        )
    )
...
def generate_api_docs():
    ...
    return {"openapi.json": api.to_json(), "spec": api.generate()}
