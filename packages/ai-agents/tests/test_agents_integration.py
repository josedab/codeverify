        ...
        mock_response = json.dumps(
            {
                "conditions": [
                    ...
                    },
                    {
                        ...
                        "variables": {"count": {"type": "int32", "range": None}},
        ...
        mock_response = json.dumps(
            {
                ...
                "secrets_detected": [
                    {"type": "openai_key", "location": {"line": 2}, "pattern": "sk-..."}
                ],
                "security_score": 30,
...
"""
        ...
        secrets = asyncio.get_event_loop().run_until_complete(agent.scan_for_secrets(code))
...
class TestAgentFactoryIntegration:
    ...
    async def test_factory_agents_work_with_mocks(self):
        ...
        result = await agent.analyze(
            "def test(): pass", {"file_path": "test.py", "language": "python"}
        )
