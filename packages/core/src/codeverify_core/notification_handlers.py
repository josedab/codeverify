...
class NotificationEventHandler:
    ...
    async def handle_analysis_failed(self, event: AnalysisFailedEvent) -> None:
        ...
        failure_configs = [
            c for c in configs if NotificationType.ANALYSIS_FAILED in c.notification_types
        ]
    ...
    async def handle_critical_finding(self, event: CriticalFindingEvent) -> None:
        ...
        critical_configs = [
            c for c in configs if NotificationType.CRITICAL_FINDING in c.notification_types
        ]
