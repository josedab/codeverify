...
class ComplianceReportGenerator:
    ...
    CONTROL_DEFINITIONS: dict[ComplianceFramework, list[dict[str, str]]] = {
        ComplianceFramework.SOC2: [
            ...
            },
            {
                ...
                "description": "Organization selects and develops ongoing evaluations",
            },
            {
                "id": "CC5.1",
            ...
            },
            {
                ...
                "description": "Organization protects against external threats",
            },
            {
                "id": "CC6.7",
                "name": "Information Transmission",
                "description": "Organization restricts transmission of confidential information",
            },
            {
                "id": "CC7.1",
                "name": "System Operations",
                "description": "Organization detects security events",
            },
            {
                "id": "CC7.2",
            ...
            },
            {
                ...
                "description": "Organization authorizes, designs, and implements changes",
            },
            {
                "id": "CC9.1",
                "name": "Risk Mitigation",
                "description": "Organization identifies and assesses risks from business partners",
            },
        ],
        ComplianceFramework.HIPAA: [
            ...
            },
            {
                ...
                "description": "Ensure all workforce members have appropriate access",
            },
            {
                "id": "164.308(a)(4)",
            ...
            },
            {
                ...
                "description": "Implement policies for disposal of ePHI",
            },
            {
                "id": "164.312(a)(1)",
                "name": "Access Control",
            ...
            },
            {
                "id": "164.312(d)",
                "name": "Authentication",
                "description": "Implement procedures to verify person seeking access",
            },
            {
                "id": "164.312(e)(1)",
        ...
        ComplianceFramework.ISO_27001: [
            ...
            },
            {
                ...
                "description": "Internal organization and mobile/teleworking",
            },
            {
                "id": "A.7",
    ...
    def generate_report(
        ...
        for control_def in controls_defs:
            ...
            status = ControlStatus.COMPLIANT if evidence_ids else ControlStatus.NOT_ASSESSED
