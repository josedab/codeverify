...
class ReachabilityAnalyzer:
    ...
    def _analyze_vulnerability(
        ...
        vuln_nodes = [
            n for n in nodes.values() if n.is_vulnerable and n.vulnerability_id == vuln.id
        ]
    ...
    def _z3_reachability_check(
        ...
        vuln_reachable_vars = [node_reachable[v.id] for v in vuln_nodes if v.id in node_reachable]
