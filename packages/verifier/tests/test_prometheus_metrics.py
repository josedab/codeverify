...
class TestCounter:
    ...
    def test_collect(self):
        ...
        counter = Counter("test_counter", "Test counter", labels=["label1"])
...
class TestGauge:
    ...
    def test_gauge_with_labels(self):
        ...
        gauge = Gauge("test_gauge", "Test gauge", labels=["instance"])
...
class TestHistogram:
    ...
    def test_observe(self):
        ...
        # Find bucket counts
        bucket_values = {
            m["labels"]["le"]: m["value"] for m in collected if "le" in m.get("labels", {})
        }
    ...
    def test_observe_with_labels(self):
        ...
        histogram = Histogram(
            "test_histogram", "Test histogram", labels=["method"], buckets=(0.1, 1.0)
        )
    ...
    def test_time_context_manager(self):
        ...
        histogram = Histogram("test_histogram", "Test histogram", buckets=(0.001, 0.01, 0.1, 1.0))
...
class TestSummary:
    ...
    def test_observe(self):
        """Test observing values."""
        summary = Summary("test_summary", "Test summary", quantiles=(0.5, 0.9))
    ...
    def test_max_age(self):
        ...
        count_metric = next((m for m in collected2 if m["name"] == "test_summary_count"), None)
...
class TestRuntimeProbeMetrics:
    ...
    def test_record_check(self):
        ...
        metrics.record_check(
            spec_id="auth_check", probe_type="precondition", passed=True, duration_seconds=0.001
        )
    ...
    def test_record_violation(self):
        ...
        metrics.record_violation(spec_id="auth_check", probe_type="precondition", severity="high")
...
class TestFormatFunctions:
    ...
    def test_format_prometheus_no_labels(self):
        ...
        metrics = [{"name": "test_gauge", "type": "gauge", "value": 100.0, "labels": {}}]
...
class TestObserveSpecCheckDecorator:
    ...
    def test_successful_check(self):
        ...
        assert (
            metrics.spec_checks_total.get(
                spec_id="test_spec", probe_type="assertion", result="pass"
            )
            == 1
        )
    ...
    def test_failed_check(self):
        ...
        assert (
            metrics.spec_checks_total.get(
                spec_id="test_spec", probe_type="assertion", result="fail"
            )
            == 1
        )
...
class TestMetricsIntegration:
    ...
    def test_on_check_performed(self):
        ...
        assert (
            metrics.spec_checks_total.get(spec_id="test", probe_type="precondition", result="pass")
            == 1
        )
    ...
    def test_on_violation(self):
        ...
        assert (
            metrics.spec_violations_total.get(
                spec_id="test", probe_type="precondition", severity="high"
            )
            == 1
        )
...
class TestMetricLabels:
    ...
    def test_to_dict(self):
        ...
        labels = MetricLabels(spec_id="test", probe_type="precondition", result="pass")
    ...
    def test_to_label_string(self):
        ...
        labels = MetricLabels(spec_id="test", result="fail")
