...
class LocalAnalyzer:
    ...
    def _security_patterns(self, content: str, file_path: Path) -> list[dict[str, Any]]:
        ...
        patterns = [
            ...
            # Eval usage
            (r"\beval\s*\(", "Dangerous eval() Usage", "security", "critical"),
            # Shell injection
            (
            ...
            # Debug code
            (r"(?i)(console\.log|print|debugger)", "Debug Statement", "maintainability", "low"),
            # TODO/FIXME
            (r"(?i)(TODO|FIXME|HACK|XXX):", "TODO Comment", "maintainability", "info"),
        ]
