...
class TestThroughput:
    def test_search_throughput(self, benchmark):
        ...
        for i in range(100):
            svc.index_entity(CodeEntity(file_path=f"f{i}.py", function_name=f"fn{i}",
                verification_status=VerificationStatus.VERIFIED if i % 2 == 0 else VerificationStatus.UNVERIFIED))
